...
public class EntryNewCommandTests : UnitTestsBase
{
    ...
    public void deve_falhar_ao_nao_informar_data_ou_definir_hoje()
    {
        ...
        action.Should().Throw<Exception>().WithMessage(HhregMessages.Entry.New.YouShouldInformADayToLog);
    }
    ...
    public void deve_falhar_ao_informar_data_invalida()
    {
        ...
        // Then
        _timeRepository!.DidNotReceive().CreateTime(Arg.Any<long>(), Arg.Any<string[]>());
        action.Should().Throw<Exception>().WithMessage(string.Format(HhregMessages.Common.CouldNotParseAsAValidDateFormat, entryDate));
    }
    ...
    public void deve_falhar_ao_nao_informar_ao_menos_uma_entrada_ou_justificativa()
    {
        ...
        // Then
        _timeRepository!.DidNotReceive().CreateTime(Arg.Any<long>(), Arg.Any<string[]>());
        action.Should().Throw<Exception>().WithMessage(HhregMessages.Entry.New.YouShouldInformAtLeastOneTimeEntryOrSetAJustificative);
    }
    ...
    public void deve_falhar_ao_informar_entradas_nao_positivas()
    {
        ...
        // Then
        _timeRepository!.DidNotReceive().CreateTime(Arg.Any<long>(), Arg.Any<string[]>());
        action.Should().Throw<Exception>().WithMessage(HhregMessages.Entry.New.EntryTimesMustBePositive);
    }
    ...
    public void deve_falhar_ao_informar_entradas_invalidas()
    {
        ...
        // Then
        _timeRepository!.DidNotReceive().CreateTime(Arg.Any<long>(), Arg.Any<string[]>());
        action.Should().Throw<Exception>().WithMessage(string.Format(HhregMessages.Common.CouldNotParseAsAValidTimeFormat, badEntry));
    }
